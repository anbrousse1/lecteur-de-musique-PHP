...
<div class="container overlay">
    ...
    <div class="blockblack">
        ...
        /**
         * il faut que l'utilisateur soit connecté pour pouvoir ajouter un commentaire donc on vérifie si une session existe
         */
        if(isset($_SESSION['login'])&&isset($_SESSION['mdp'])) {
            ...
            if (isset($_POST['valider'])) {
                if (isset($_POST['commentaire'])) {
                    ...
                    $avis = $_POST['avis'];
                    /**
                     * on ajoute l'avis puis on ajoute le commentaire
                     */
                    $mg->ajouterAvis($avis, $titre);
                    $res = $cg->ajoutCommentaire($titre, $auteur, $commentaire, $date);
                    if ($res === false) {
                        echo "<p>Votre commentaire n'a pas pu être ajouté. Désolé.</p>";
                    } else {
                        echo "<p>Votre commentaire a été ajouté </p>";
                    }
                }
            }
        }else {
