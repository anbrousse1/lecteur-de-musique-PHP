...
<div class="container overlay">
    ...
    <div class="blockblack">
        ...
        echo "<p>Voici le résultat de votre recherche : </p></br>";
        if(isset($_POST['rechercher'])){
            if(isset($_POST['barreRecherche'])) {
                $recherche = $_POST['barreRecherche'];
                $r=$mg->getTitreByNom($dataError,$recherche);
                if($r==null){
                    echo "<p> Aucun morceau trouvé !</p>";
                }else{
                    echo "<a href=\"#\" data-toggle=\"modal\" data-target=\"#".$r->titre."\">".$r->titre."</a></br>";
                }
            }
        }
